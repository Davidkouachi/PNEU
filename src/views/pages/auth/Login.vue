                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-10 px-8 sm:px-10" style="border-radius: 7px">
                    <form @submit.prevent="connectLoginForm" autocomplete="off">
                        <div class="text-center mb-8">
                            <img width="280" src="@/assets/img/logo/light/2.png" class="mb-1 w-23 shrink-0 mx-auto" alt="Logo">
...
const backgroundImage = new URL('@/assets/img/plan/4.jpg', import.meta.url).href
